<div class="servicos index">
	...
	<tr>
		...
		<td><?php echo h($servico['Servico']['valor']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $servico['Servico']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $servico['Servico']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
